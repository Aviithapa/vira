...
rangy.createModule("DomRange", function (b) {
    ...
    function i(b) {
        for (
            var c, d, h = a(b.range).createDocumentFragment();
            (d = b.next());
    ...
    function j(b) {
        for (
            var c, d = a(b.range).createDocumentFragment(), h;
            (c = b.next());
        ...
        getSubtreeIterator: function () {
            ...
            if (this.isSingleCharacterDataNode)
                ...
                var c = this._current,
                    ...
                    e = c,
                    j = l.getNodeLength(c);
                l.isAncestorOf(c, this.sc, !0) &&
                    ((d = this.sc), (h = this.so));
                l.isAncestorOf(c, this.ec, !0) &&
                    ((e = this.ec), (j = this.eo));
                J(b, d, h, e, j);
            }
...
rangy.createModule("WrappedSelection", function (b, c) {
    ...
    function k(a) {
        ...
        if ("None" == a.docSelection.type) f(a);
            ...
            if (c && "undefined" != typeof c.text) h(a, c);
                ...
                for (
                    var d, j = m.getDocument(c.item(0)), k = 0;
                    k < a.rangeCount;
                    ++k
                )
                    (d = b.createRange(j)),
                        d.selectNode(c.item(k)),
                        a._ranges.push(d);
    ...
    if (!D && E && s.areHostMethods(t, ["removeAllRanges", "addRange"])) {
        ...
        return (
            c.fail("No means of selecting a Range or TextRange was found"), !1
        );
            ...
            if (l && v && a.docSelection.type == "Control") k(a);
                ...
                if (a.rangeCount) {
                    for (var c = 0, d = a.rangeCount; c < d; ++c)
                        a._ranges[c] = new b.WrappedRange(
                            a.nativeSelection.getRangeAt(c)
                        );
    ...
    u.toHtml = function () {
        ...
        if (this.rangeCount) {
            for (
                var a = x
                        .getRangeDocument(this._ranges[0])
                        .createElement("div"),
                    b = 0,
...
(function (b) {
    var c = [
        ...
        a = function (a) {
            ...
            return e
                ? parseInt(b.getStyle("width").from(a), 10) < a.offsetWidth
                : !1;
        };
...
wysihtml5.dom.hasElementWithTagName = (function () {
    ...
    return function (a, d) {
        var e =
                (a._wysihtml5_identifier || (a._wysihtml5_identifier = c++)) +
                ":" +
                d,
            f = b[e];
...
(function (b) {
    ...
    b.dom.hasElementWithClassName = function (d, e) {
        ...
        var f =
                (d._wysihtml5_identifier || (d._wysihtml5_identifier = a++)) +
                ":" +
                e,
            g = c[f];
...
(function (b) {
    b.simulatePlaceholder = function (c, a, d) {
        var e = function () {
            ...
            f = function () {
                a.isEmpty() &&
                    (a.setValue(d), b.addClass(a.element, "placeholder"));
            };
        ...
        c.observe(e.element.ownerDocument, "keydown", function (g) {
            ...
            if (!(g.shiftKey || (i !== b.ENTER_KEY && i !== b.BACKSPACE_KEY))) {
                ...
                (h = c.getParentElement(h, { nodeName: a }, 4))
                    ? "LI" === h.nodeName &&
                      (i === b.ENTER_KEY || i === b.BACKSPACE_KEY)
                        ? setTimeout(function () {
                              var a = e.selection.getSelectedNode(),
                                  b;
                              a &&
                                  ((b = c.getParentElement(
                                      a,
                                      { nodeName: d },
                                      2
                                  )) ||
    ...
    f.prototype = {
            ...
            for (var d; a; ) {
                if (this.cssClass)
                    if (((d = this.cssClass), a.className)) {
                        var e =
                            a.className.match(this.similarClassRegExp) || [];
                        d = e[e.length - 1] === d;
                    } else d = !1;
                else d = !0;
                if (
        ...
        undoToRange: function (a) {
            ...
            c.length
                ...
                : ((c = a.endContainer.ownerDocument.createTextNode(
                      b.INVISIBLE_SPACE
                  )),
                  a.insertNode(c),
                  a.selectNode(c),
        ...
        selectNode: function (a, c) {
            ...
            f && d
                ? a.collapse(!1)
                : f && (a.setStartAfter(c), a.setEndAfter(c));
        },
        ...
        isAppliedToRange: function (a) {
            ...
            if (!e.length)
                return (d = this.getAncestorWithClass(a.startContainer))
                    ? [d]
                    : !1;
            ...
            if (r)
                h.selection.executeAndRestoreSimple(function () {
                    ...
                    if (!e && r.nodeName === (j || "DIV")) {
                        ...
                        h &&
                            !d(h) &&
                            e.parentNode.insertBefore(f.createElement("br"), h);
                        i &&
                            !d(i) &&
        ...
        exec: function (a, d) {
            a.commands.support(d)
                ? (a.doc.execCommand(d, !1, null),
                  b.browser.autoScrollsToCaret() ||
                      a.selection.scrollIntoView())
                ...
                d.observe(this.element, "contextmenu", function () {
                    ...
                    i = setInterval(function () {
                        f.getElementById("_wysihtml5-redo")
                            ? (k(), e.redo())
                            : f.getElementById("_wysihtml5-undo") ||
                              (k(), e.undo());
                    }, 400);
                    h ||
                        ((h = !0),
...
(function (b) {
    ...
    b.views.Composer = b.views.View.extend({
        ...
        getValue: function (a) {
            var c = this.isEmpty()
                ? ""
                : b.quirks.getCorrectInnerHTML(this.element);
        ...
        _initAutoLinking: function () {
            ...
            if (this.config.autoLink) {
                ...
                c.observe(this.element, "keydown", function (a) {
                    if (g.length) {
                        var a = d.selection.getSelectedNode(
                ...
                ? a.supportsEvent("resizeend") &&
                  c.observe(f, "resizeend", function (a) {
                      for (
                          ...
                          (k = d[h]),
                              c[k] &&
                                  (a.setAttribute(k, parseInt(c[k], 10)),
                                  (c[k] = ""));
                      b.quirks.redraw(f);
                  })
...
(function (b) {
    ...
    b.views.Composer.prototype.observe = function () {
        var e = this,
            ...
            i = this.element,
            h = a.supportsEventsInIframeCorrectly()
                ? i
                : this.sandbox.getWindow(),
            k = a.supportsEvent("drop")
                ? ["drop", "paste"]
                : ["dragdrop", "paste"];
        ...
        c.observe(h, "blur", function () {
            f !== e.getValue() &&
                e.parent.fire("change").fire("change:composer");
    ...
    b.views.Synchronizer = Base.extend({
        ...
        fromComposerToTextarea: function (c) {
            this.textarea.setValue(
                b.lang.string(this.composer.getValue()).trim(),
                c
            );
        },
    ...
    b.toolbar.Dialog = b.lang.Dispatcher.extend({
        ...
        _serialize: function () {
            for (
                ...
                a[b[f].getAttribute("data-wysihtml5-dialog-field")] =
                    b[f].value;
            return a;
        },
        _interpolate: function (a) {
            for (
                var b,
                    ...
                    g = this.container.querySelectorAll(
                        "[data-wysihtml5-dialog-field]"
                    ),
                    i = g.length,
                    h = 0;
    ...
    b.toolbar.Speech = function (g, i) {
        ...
        if (b.browser.supportsSpeechApiOn(h)) {
            ...
            c.observe(h, "click", function (a) {
                c.hasClass(i, "wysihtml5-command-disabled") &&
                    a.preventDefault();
                a.stopPropagation();
            });
                ...
                if (
                    ...
                    this.commandsDisabled
                        ...
                        : ((f = this.composer.commands.state(g.name, g.value)),
                          b.lang.object(f).isArray() &&
                              (f = 1 === f.length ? f[0] : !0),
                          c.removeClass(g.link, "wysihtml5-command-disabled"),
                          g.group &&
                              c.removeClass(
                                  g.group,
                                  "wysihtml5-command-disabled"
                              )),
                    g.state !== f)
                )
                    (g.state = f)
                        ? (c.addClass(g.link, "wysihtml5-command-active"),
                          g.group &&
                              c.addClass(g.group, "wysihtml5-command-active"),
                          g.dialog &&
                              ("object" === typeof f
                                  ? g.dialog.show(f)
                                  : g.dialog.hide()))
        ...
        constructor: function (a, d) {
            ...
            if (
                ...
                this.observe("beforeload", function () {
                    ...
                    this.config.toolbar &&
                        (this.toolbar = new b.toolbar.Toolbar(
                            this,
                            this.config.toolbar
                        ));
                });
