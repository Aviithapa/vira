      ...
      <div class="npc_page">
        ...
        <div class="npc_sidebar_wrapper">
          <div class="npc_sidebar">
            ...
            <a href="{{ url('requirement-bachelor') }}" class="npc_sidebar_button" data-target="npc_min_bachelor">
        ...
        <div class="npc_content_area_wrapper">
          <div class="npc_content">
            ...
            <!-- Diploma section -->
            <div id="npc_min_diploma" class="npc_content_wrapper active">
              <div class="npc_min_diploma_content">
                <div class="npc_pdf_container">
                  <embed
                    src="{{ $diploma_req->getImageUrlAttribute() }}"
