      ...
      <div class="npc_page">
        ...
        <div class="npc_sidebar_wrapper">
          <div class="npc_sidebar">
            <a href="{{ url('act') }}" class="npc_sidebar_button active" data-target="npc_act">
              Act
            </a>
        ...
        <div class="npc_content_area_wrapper">
          <div class="npc_content">
            <!-- act section  -->
            <div id="npc_act" class="npc_content_wrapper active">
              <div class="npc_act_content">
                <div class="npc_pdf_container">
                  <embed
                    src="{{ $act->getImageUrlAttribute() }}"
