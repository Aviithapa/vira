...
@section('content')
        ...
        <!-- start page title -->
                @include('admin.component.breadcrumb', ['title' => "Staff Management"])
        <!-- end page title -->
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="p-3">
                                <h5 class="header-title mb-0" style="text-transform: capitalize;">Staff List</h5>
                            </div>
                                                                ...
                                                                <div>
                                                                    <div class="col-lg-12 col-md-12 col-sm-12"> 
                                                                        <div class="mb-3">
                                                                            ...
                                                                            <input type="text" class="form-control" placeholder="Staff Name" name="title"  required value="{{ isset($model) ? $model->title :old('title') }}">
                                                                                @if($errors->any())
                                                                                    {{ $errors->first('title') }}
                                                                                @endif
                                                                        </div>
                                                ...
                                                <div class="row">
                                                        @foreach ($banner as $ba)
                                                                <div class="col-xl-4" style="position: relative; margin-top: 2px; text-align:center;">
                                                                        <a  data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@fat"  data-attr="{{ route( 'staff.destroy', ['staff'=> $ba->id]) }}" style="cursor: pointer;">  <i class="bi-trash" style="color: red;
                                                                        border-radius: 50%;
                                                                        padding: 3px;
                                                                        background: white;
                                                                        cursor: pointer;
