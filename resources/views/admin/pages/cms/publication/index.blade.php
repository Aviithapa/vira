...
@section('content')
        ...
        <!-- start page title -->
                @include('admin.component.breadcrumb', ['title' => "Publications"])
        <!-- end page title -->
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="p-3">
                                <h5 class="header-title mb-0" style="text-transform: capitalize;">Publication</h5>
                            </div>
                                        ...
                                        <div class="card">
                                                <div class="card-body p-3">
                                                        <form method="POST" action="{{ route('publication.store') }}" enctype="multipart/form-data">
                                                                ...
                                                                <button class="btn btn-primary" type="submit">Create Publication</button>
                                                        </form>
                                                </div>
                                        </div>
                                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                                                ...
                                                @foreach ($publication as $ba)
                                                        <div class="col-xl-4" style="position: relative; margin-top: 2px; text-align:center;">
                                                            <a  data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@fat"  data-attr="{{ route( 'publication.destroy', ['publication'=> $ba->id]) }}" style="cursor: pointer;">  <i class="bi-trash" style="color: red;
                                                                        border-radius: 50%;
                                                                        padding: 3px;
                                                                        background: white;
                                                                        cursor: pointer;
