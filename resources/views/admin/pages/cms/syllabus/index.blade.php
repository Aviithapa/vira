...
@section('content')
        ...
        <!-- start page title -->
                @include('admin.component.breadcrumb', ['title' => "Syllabus Management"])
        <!-- end page title -->
                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="p-3">
                                <h5 class="header-title mb-0" style="text-transform: capitalize;">Syllabus Management</h5>
                            </div>
                            <div id="yearly-sales-collapse" class="collapse show row">
                                ...
                                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                        ...
                                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                                                ...
                                                @foreach ($syllabus as $ba)
                                                        <div class="col-xl-4" style="position: relative; margin-top: 2px; text-align:center;">
                                                            <a  data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@fat"  data-attr="{{ route( 'syllabus.destroy', ['syllabu'=> $ba->id]) }}" style="cursor: pointer;">  <i class="bi-trash" style="color: red;
                                                                        border-radius: 50%;
                                                                        padding: 3px;
                                                                        background: white;
                                                                        cursor: pointer;
                                                ...
                                                <div style="padding: 10px; float:right;">
                                                        {{  $syllabus->appends(request()->query())->links('admin.layout.pagination') }}
                                                </div>
                                        </div>
                                </div>
